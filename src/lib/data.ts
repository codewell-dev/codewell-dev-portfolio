  ...
  {
    {
      ...
      tag_uk:  'Full Stack',
      year:    '2024',
      desc_en: 'Production-grade e-commerce storefront built with a brutalist editorial design system. Newsprint palette, ink rules, and Playfair italic headlines — engineered like a real brand, not a demo.',
      desc_uk: 'Продакшн-рівний e-commerce магазин з брутальною редакційною дизайн-системою. Газетна палітра, чорні правила та italic-заголовки — зібрано як справжній бренд, а не демо.',
      tech:    ['Next.js 14', 'TypeScript', 'Redux Toolkit', 'RTK Query', 'Tailwind CSS'],
      accent:  '#b5451b',
