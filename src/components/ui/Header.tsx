      ...
      >
        <div className="max-w-screen-xl mx-auto px-6 md:px-10 h-14 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            {navLinks.map(l => (
              <a
                ...
                onMouseEnter={e => { hoverOn(); (e.currentTarget as HTMLElement).style.color = 'var(--cream)' }}
                onMouseLeave={e => { hoverOff(); (e.currentTarget as HTMLElement).style.color = 'var(--muted)' }}
              >
                {l.label}
              </a>
            ))}
          ...
          <div className="flex items-center gap-3">
            <div className="hidden md:flex" style={{ border: '1px solid var(--border)' }}>
                ...
                <span
                  ...
                  style={{
                    ...
                    transform:
                      ...
                      open && i === 2 ? 'rotate(-45deg) translate(3.5px,-3.5px)' : 'none',
            ...
            <nav className="flex flex-col gap-6 mb-14">
              {navLinks.map((l, i) => (
                <motion.a
                  ...
                  style={{ fontSize: 'clamp(2.2rem, 10vw, 4rem)', letterSpacing: '-0.04em' }}
                >
                  {l.label}
                </motion.a>
              ))}
