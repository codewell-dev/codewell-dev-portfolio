...
export default function HeroScene() {
  ...
  useEffect(() => {
    ...
    const ringMat = new THREE.MeshBasicMaterial({ color: 0x6ee7b7, opacity: 0.18, transparent: true })
    ...
    const pMat = new THREE.PointsMaterial({ color: 0x6ee7b7, size: 0.012, opacity: 0.45, transparent: true })
